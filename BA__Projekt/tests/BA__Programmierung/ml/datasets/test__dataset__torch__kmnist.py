...
class TestKMNISTDatasetLoading(unittest.TestCase):

    @patch("BA__Programmierung.ml.datasets.dataset__torch__base_image_classification.BaseImageCSVClassificationDataset")
    def test_load_kmnist_datasets(self, mock_base_image_classification_dataset):
        ...
        train_csv_path = "fake_path/kmnist-train.csv"
        test_csv_path = "fake_path/kmnist-test.csv"

        # Call the function to load datasets
        train_ds, test_ds = load_kmnist_datasets(train_csv_path, test_csv_path)
    ...
    def test_invalid_csv_path(self, mock_base_image_classification_dataset):
        ...
        with self.assertRaises(FileNotFoundError):
            load_kmnist_datasets("invalid_path/kmnist-train.csv", "invalid_path/kmnist-test.csv")
