...
def load_ensemble(model_path, base_config, device):
    ...
    Example
    -------
    >>> model = load_ensemble('path/to/model.pth', base_config, device)
    """
...
def evaluate_and_save_dashboard(mu, v, alpha, beta, targets, scaler_y, save_dir):
    ...
    Example
    -------
    >>> evaluate_and_save_dashboard(mu, v, alpha, beta, targets, scaler_y, "save_directory")
    """
    ...
    ax.set_title("True vs Predicted Compressive Strength")
    ax.set_xlabel("True Compressive Strength")
    ...
    ax.set_title("Residuals vs True Compressive Strength")
    ax.set_xlabel("True Compressive Strength")
...
def main():
    ...
    save_dir = "assets/viz/ednn_regression__concrete_compressive_strength"
