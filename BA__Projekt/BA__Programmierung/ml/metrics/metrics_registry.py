...
class MetricsRegistry: # (metaclass=Singleton):
    """
    Singleton registry for storing and retrieving evaluation metrics by token.

    Supports both single-batch and accumulated metrics.
    """
    ...
    def register(self, token: str, fn: Callable, name: str = None, accumulate: bool = False):
        """
    ...
    def report(self, token: str, verbose: bool = True) -> dict[str, float | None]:
        """
        Compute and optionally print all accumulated metrics.
    ...
    # @staticmethod
    # def get_metric_bundles() -> dict[str, list[str]]:
    #         """
